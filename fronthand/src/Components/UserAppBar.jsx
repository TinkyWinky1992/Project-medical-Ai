...
import { main_pages, dialog_pages, settings_pages} from "../routing/routes";
...
const UserAppBar =forwardRef((props, ref)=> {
  ...
  const handleAuthUser= async() => {
    try{  
      await checkAuth(Cookies.get('User_token'));
  ...
  const handleChange = (event, newValue) => {
    ...
    navigate(settings_pages[newValue].route_url);
